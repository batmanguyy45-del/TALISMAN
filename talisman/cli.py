...
def cmd_autopilot(
    ...
    """
    🚀 AUTOPILOT — Full automated security assessment in one command.
    ...
    console.print(Panel(
        ...
        title="🚀 TALISMAN AUTOPILOT — MR MARCUS TAYK", border_style="cyan",
    ))
...
def session_summary(session_name: str = typer.Argument(...)):
    ...
    async def _r():
        ...
        console.print(Panel(
            ...
            title=f"📊 {session_name}", border_style="cyan"))
    _run(_r())
