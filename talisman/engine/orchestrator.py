...
class ModuleRegistry:
 ...
 MODULE_MAP: dict[str, str] = {
   ...
   "ad.kerberos":    "talisman.modules.activedirectory.kerberos",
    ...
    "scanner.mass_assignment": "talisman.modules.scanner.mass_assignment",
    "scanner.mass":    "talisman.modules.scanner.mass_assignment",
    "scanner.host_header":  "talisman.modules.scanner.host_header",
    "scanner.host":    "talisman.modules.scanner.host_header",
    "scanner.csrf":    "talisman.modules.scanner.csrf",
    "scanner.cache_deception": "talisman.modules.scanner.cache_deception",
